...
- (NSArray *)findMulti:(ZXDecodeHints *)hints error:(NSError **)error {
  ...
  for (NSMutableArray *pattern in patternInfo) {
      NSMutableArray *patternPara = [NSMutableArray arrayWithArray:pattern];
      //!@#
    patternPara = [ZXResultPoint orderBestPatterns2:pattern];
    [result addObject:[[ZXQRCodeFinderPatternInfo alloc] initWithPatternCenters:patternPara]];
  }
